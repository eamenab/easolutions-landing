...
const ContactSection = () => {
  ...
  return <section id="contact" className="section-padding bg-ea-gray" ref={sectionRef}>
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-2 items-center lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                {contactInfo.map((item, index) => <div key={index} className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      {item.link ? <a href={item.link} className="text-ea-blue hover:underline" target={item.link.startsWith('http') ? "_blank" : undefined} rel={item.link.startsWith('http') ? "noopener noreferrer" : undefined}>
                          {item.content}
                        </a> : <p className="text-gray-600">{item.content}</p>}
                    </div>
                  </div>)}
              </div>
            </div>
            ...
            <div className="glass-card p-8 rounded-2xl">
              ...
              <a href="https://calendly.com" target="_blank" rel="noopener noreferrer" className="inline-block btn-primary w-full text-center">
                Reservar una Demo
              </a>
            </div>
          </div>
